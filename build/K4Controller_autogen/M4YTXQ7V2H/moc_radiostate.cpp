...
template <> constexpr inline auto RadioState::qt_create_metaobjectdata<qt_meta_tag_ZN10RadioStateE_t>()
{
    ...
    QtMocHelpers::UintData qt_enums {
        ...
        // enum 'AGCSpeed'
        QtMocHelpers::EnumData<enum AGCSpeed>(76, 76, QMC::EnumFlags{}).add({
            {   77, AGCSpeed::AGC_Off },
            {   78, AGCSpeed::AGC_Slow },
            {   79, AGCSpeed::AGC_Fast },
        }),
    };
...
void RadioState::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 30: _t->rfGainBChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 31: _t->squelchBChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 32: _t->voxChanged((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
        case 33: _t->notchChanged(); break;
        case 34: _t->stateUpdated(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (RadioState::*)(int )>(_a, &RadioState::squelchChanged, 29))
            return;
        if (QtMocHelpers::indexOfMethod<void (RadioState::*)(int )>(_a, &RadioState::rfGainBChanged, 30))
            return;
        if (QtMocHelpers::indexOfMethod<void (RadioState::*)(int )>(_a, &RadioState::squelchBChanged, 31))
            return;
        if (QtMocHelpers::indexOfMethod<void (RadioState::*)(bool )>(_a, &RadioState::voxChanged, 32))
            return;
        if (QtMocHelpers::indexOfMethod<void (RadioState::*)()>(_a, &RadioState::notchChanged, 33))
            return;
        if (QtMocHelpers::indexOfMethod<void (RadioState::*)()>(_a, &RadioState::stateUpdated, 34))
            return;
    }
}
...
// SIGNAL 30
void RadioState::rfGainBChanged(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 30, nullptr, _t1);
}

// SIGNAL 31
void RadioState::squelchBChanged(int _t1)
{
